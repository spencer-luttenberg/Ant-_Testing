...
BOOL MyANTrxService::Init()
{
	...
	uiDSIThread = DSIThread_CreateThread(&MyANTrxService::RunMessageThread, this);
	assert(uiDSIThread);
...
void MyANTrxService::PrintUsbDescr() {
...
//
////////////////////////////////////////////////////////////////////////////////
DSI_THREAD_RETURN MyANTrxService::RunMessageThread(void* pvParameter_)
{
	((MyANTrxService*)pvParameter_)->MessageThread();
	return NULL;
}


BOOL MyANTrxService::TransmitMessage(UCHAR channel, UCHAR tx_buffer[ANT_STANDARD_DATA_PAYLOAD_SIZE])
{
	if (bTXwaiting) {
		return FALSE;
	}
...
// Run message thread
////////////////////////////////////////////////////////////////////////////////
void MyANTrxService::MessageThread()
{
...
void MyANTrxService::ProcessMessage(ANT_MESSAGE stMessage, USHORT usSize_)
{
	BOOL bStatus;
		...
		// Burst not supported by ANT+ HRM
	{
		...
		if (usSize_ > MESG_DATA_SIZE)
		{
			...
			if (bDisplay && ucFlag & ANT_EXT_MESG_BITFIELD_DEVICE_ID)
			{
				...
				bStatus = pclMessageObject->SetChannelID(0, usDeviceNumber, ucDeviceType__, ucTransmissionType, MESSAGE_TIMEOUT);//hard-coded for now
				DSIThread_Sleep(100);
...
//
////////////////////////////////////////////////////////////////////////////////
void MyANTrxService::DetectDevice(UCHAR& ucDeviceType_, BOOL& bOldToggleBit_, UCHAR& ucToggleAttempts_, BOOL bToggleBit)
{
